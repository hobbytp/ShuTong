...
import { createVideoGenerationWindow, generateVideo } from '../../electron/video_service';
...
describe('Video Service', () => {
    ...
    it('should resolve promise when video-generated is received', async () => {
        ...
        // Simulate IPC reply
        const onComplete = mocks.mockIpcMain.on.mock.calls.find(call => call[0] === 'video-generated')[1];
    ...
    it('should reject promise when video-error is received', async () => {
        ...
        const onError = mocks.mockIpcMain.on.mock.calls.find(call => call[0] === 'video-error')[1];
