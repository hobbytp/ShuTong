    ...
    return (
        <div className="p-8 max-w-3xl mx-auto text-zinc-50 min-h-screen">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-lg font-semibold mb-4 text-zinc-200">New Entry</h2>
                ...
                <textarea
                    ...
                    placeholder={type === 'intention' ? "What are your main goals for today?" : "How did today go? What did you achieve?"}
            ...
            {/* List Section */}
            <h2 className="text-xl font-bold mb-6 text-zinc-200">History</h2>
            <div className="flex flex-col gap-4">
                ...
                {entries.length === 0 && (
                    <div className="text-center py-12 bg-zinc-900/30 rounded-xl border border-dashed border-zinc-800">
                        <p className="text-zinc-500">No journal entries yet. Start writing above!</p>
                    </div>
                )}
            </div>
        </div>
